...
void loop() {
  //knightRider(2, 10, 2, 0xFF1000); // Cycles, Speed, Width, RGB Color (original orange-red)
  //knightRider(2, 1, 2, 0xFF00FF); // Cycles, Speed, Width, RGB Color (purple)
  //knightRider(2, 1, 2, 0x0000FF); // Cycles, Speed, Width, RGB Color (blue)
  knightRider(2, 1, 2, 0xFF0000); // Cycles, Speed, Width, RGB Color (red)
  knightRider(2, 10, 2, 0x00FF00); // Cycles, Speed, Width, RGB Color (green)
  //knightRider(2, 1, 2, 0xFFFF00); // Cycles, Speed, Width, RGB Color (yellow)
  //knightRider(2, 1, 2, 0x00FFFF); // Cycles, Speed, Width, RGB Color (cyan)
  //knightRider(2, 1, 2, 0xFFFFFF); // Cycles, Speed, Width, RGB Color (white)
  clearStrip();
  delay(2000);
